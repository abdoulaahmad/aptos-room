...
import { ArrowRight, Menu, X, Shield, Lock, Zap, Code, CheckCircle, AlertTriangle, Database, Cpu, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-aptos-dark text-white selection:bg-aptos-cyan selection:text-black font-sans overflow-x-hidden">
      ...
      <footer className="bg-black text-gray-500 py-12 border-t border-gray-900 relative">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-6 text-xs font-bold font-mono uppercase tracking-wider">
               <a href="https://x.com/AptosRoom?s=09" target="_blank" rel="noopener noreferrer" className="hover:text-aptos-cyan transition-colors">Twitter</a>
               <a href="https://t.me/+nzOvO5pymwY2Zjhk" target="_blank" rel="noopener noreferrer" className="hover:text-aptos-cyan transition-colors">Telegram</a>
               <a href="https://discord.gg/CYVKTxyEvz" target="_blank" rel="noopener noreferrer" className="hover:text-aptos-cyan transition-colors">Discord</a>
            </div>
        </div>
      </footer>
    </div>
